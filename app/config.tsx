...
export const config = {
    ...
    embeddingsModel: "embedding-001",//"embedding-001",//'text-embedding-3-small', // Ollama: 'llama2', 'nomic-embed-text' // OpenAI 'text-embedding-3-small', 'text-embedding-3-large',

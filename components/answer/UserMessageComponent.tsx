    ...
    return (
        <div className="dark:bg-stone-950 bg-white shadow-lg rounded-lg p-4 mt-4">
            <div className="flex items-center">
                ...
                <h2 className="flex items-center text-lg leading-none py-2"> {<Search size={18} className="mr-2" />} </h2>
                <h1 className="text-lg font-semibold flex-grow dark:text-white text-black">{message}</h1>
                {/* 4. Render Icons */}
